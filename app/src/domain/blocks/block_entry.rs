...
use crate::__registry__::all_blocks::{
    ALL_CHAT_BLOCKS, ALL_FAQ_BLOCKS, ALL_FOOTER_BLOCKS, ALL_HEADER_BLOCKS, ALL_INTEGRATION_BLOCKS, ALL_LOGIN_BLOCKS,
    ALL_PRICING_BLOCKS, ALL_SIDENAV_BLOCKS, BlockIdKebab,
};
...
impl BlockEntry {
    ...
    /// Get pricing blocks
    pub fn get_pricing_blocks() -> Vec<BlockEntry> {
        ALL_PRICING_BLOCKS.to_vec()
    }

    /// Get chat blocks
    pub fn get_chat_blocks() -> Vec<BlockEntry> {
        ALL_CHAT_BLOCKS.to_vec()
    }
}
