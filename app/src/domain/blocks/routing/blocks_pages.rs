...
#[component]
pub fn PricingBlocks() -> impl IntoView {
    view! { <BlocksPage block_type="Pricing" get_blocks=BlockEntry::get_pricing_blocks /> }
}

#[component]
pub fn ChatBlocks() -> impl IntoView {
    view! { <BlocksPage block_type="Chat" get_blocks=BlockEntry::get_chat_blocks /> }
}
