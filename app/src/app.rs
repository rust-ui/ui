...
use crate::domain::blocks::routing::blocks_pages::{
    ChatBlocks, FaqBlocks, FootersBlocks, HeadersBlocks, IntegrationsBlocks, LoginBlocks, PricingBlocks, SidenavBlocks,
};
                ...
                <main id=DATA_SCROLL_TARGET class="overflow-y-auto flex-1 overflow-x-clip">
                    <Routes fallback=|| PageNotFound.into_view()>
                        ...
                        <ParentRoute path=StaticSegment(BlockRoutes::base_segment()) view=BlocksLayout>
                            ...
                            <Route path=StaticSegment(BlockRoutes::Pricing.as_ref()) view=PricingBlocks />
                            <Route path=StaticSegment(BlockRoutes::Chat.as_ref()) view=ChatBlocks />
                        </ParentRoute>
