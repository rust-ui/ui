...
///
/// # Errors
/// Returns an error when local or remote report delivery fails.
#[cfg(feature = "server")]
...
///
/// # Errors
/// Returns an error when remote report delivery fails.
#[cfg(feature = "server")]
...
///
/// # Errors
/// Returns an error when report persistence or server-function handling fails.
#[server]
