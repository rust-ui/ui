...
#[component]
pub fn AreaChart08() -> impl IntoView {
        ...
        <div class="flex relative flex-col rounded-xl border transition-all duration-200 ease-in-out hover:z-30 group">
            ...
            <Card class="gap-0 py-0 rounded-none border-0 shadow-none">
                <CardHeader class="py-6">
                    <CardTitle>Area Chart - Grid</CardTitle>
                    <CardDescription>Showing total visitors with Y-axis and grid lines</CardDescription>
                </CardHeader>

                <CardContent class="px-2">
                    // * AreaChart demo with Y-axis and grid enabled
