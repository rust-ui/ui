---
title: "Demo Dropdown Menu End"
name: "demo_dropdown_menu_end"
cargo_dependencies: []
registry_dependencies: ["dropdown_menu", "separator"]
type: "components:demos"
path: "demos/demo_dropdown_menu_end.rs"
---

# Demo Dropdown Menu End
...
#[component]
pub fn DemoDropdownMenuEnd() -> impl IntoView {
    view! {
        <DropdownMenu align=DropdownMenuAlign::End>
            <DropdownMenuTrigger>"Open (End)"</DropdownMenuTrigger>

            <DropdownMenuContent>
                <DropdownMenuLabel>"End Menu"</DropdownMenuLabel>
