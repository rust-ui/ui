---
title: "Demo Dropdown Menu Start Outer"
name: "demo_dropdown_menu_start_outer"
cargo_dependencies: []
registry_dependencies: ["dropdown_menu", "separator"]
type: "components:demos"
path: "demos/demo_dropdown_menu_start_outer.rs"
---

# Demo Dropdown Menu Start Outer
...
ui add demo_dropdown_menu_start_outer
```
...
#[component]
pub fn DemoDropdownMenuStartOuter() -> impl IntoView {
    view! {
        <DropdownMenu align=DropdownMenuAlign::StartOuter>
            <DropdownMenuTrigger>"Open (StartOuter)"</DropdownMenuTrigger>

            <DropdownMenuContent>
                <DropdownMenuLabel>"StartOuter Menu"</DropdownMenuLabel>
