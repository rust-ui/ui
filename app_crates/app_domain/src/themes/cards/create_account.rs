...
#[component]
pub fn CardCreateAccount() -> impl IntoView {
    view! {
        <Card>
            <CardHeader>
            ...
            <CardContent class="flex flex-col gap-4">
                ...
                <form class="flex flex-col gap-4">
                    <div class="flex flex-col gap-3">
                        <Label html_for="email-create-account">Email</Label>
                        <Input
                            attr:id="email-create-account"
                            attr:r#type="email"
                    ...
                    <div class="flex flex-col gap-3">
                        <Label html_for="password-create-account">Password</Label>
                        <Input
                            attr:id="password-create-account"
...
#[component]
pub fn LogoGithub() -> impl IntoView {
    view! {
        <svg viewBox="0 0 438.549 438.549" class="mr-2 size-4">
            <path
                fill="currentColor"
